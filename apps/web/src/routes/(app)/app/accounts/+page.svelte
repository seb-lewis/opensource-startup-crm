<script lang="ts">
	...
	import { INDUSTRY_OPTIONS, ACCOUNT_TYPE_OPTIONS } from '@opensource-startup-crm/constants';
			...
			<div class="flex flex-col gap-3 sm:flex-row">
				...
				<div class="relative">
					...
					<input
						...
						class="min-w-[250px] rounded-lg border border-gray-300 bg-white py-2.5 pl-10 pr-4 text-sm text-gray-900 focus:border-transparent focus:outline-none focus:ring-2 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-800 dark:text-white"
				...
				<div class="relative">
					...
					<select
						...
						class="min-w-[120px] appearance-none rounded-lg border border-gray-300 bg-white py-2.5 pl-10 pr-8 text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-800 dark:text-white"
				...
				<a
					...
					class="inline-flex items-center gap-2 whitespace-nowrap rounded-lg bg-blue-600 px-4 py-2.5 text-sm font-medium text-white transition-colors hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
				>
					<Plus class="h-4 w-4" />
					New Account
				</a>
			...
			<table class="w-full">
				<thead class="border-b border-gray-200 bg-gray-50 dark:border-gray-600 dark:bg-gray-700">
					<tr>
						<th
							scope="col"
							class="cursor-pointer px-6 py-4 text-left text-xs font-medium uppercase tracking-wider text-gray-500 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-600"
						...
						<th
							scope="col"
							class="hidden px-6 py-4 text-left text-xs font-medium uppercase tracking-wider text-gray-500 sm:table-cell dark:text-gray-400"
							>Industry</th
						>
						<th
							scope="col"
							class="hidden px-6 py-4 text-left text-xs font-medium uppercase tracking-wider text-gray-500 md:table-cell dark:text-gray-400"
							>Type</th
						>
						<th
							scope="col"
							class="hidden px-6 py-4 text-left text-xs font-medium uppercase tracking-wider text-gray-500 lg:table-cell dark:text-gray-400"
							>Contact Info</th
						>
						<th
							scope="col"
							class="hidden px-6 py-4 text-left text-xs font-medium uppercase tracking-wider text-gray-500 xl:table-cell dark:text-gray-400"
							>Revenue</th
						>
						<th
							scope="col"
							...
							>
								<td class="px-6 py-4">
									<div class="flex items-center gap-3">
										...
										<div class="min-w-0 flex-1">
											<a href="/app/accounts/{account.id}" class="group block">
												<p
								...
								<td class="hidden px-6 py-4 sm:table-cell">
									<span class="text-sm text-gray-600 dark:text-gray-300"
										>{toLabel(account.industry, INDUSTRY_OPTIONS, '-')}</span
									>
								</td>
