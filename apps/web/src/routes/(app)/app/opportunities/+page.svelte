<script lang="ts">
	...
	import { opportunityStages } from '$lib/data/index.js';
	...
	let opportunityToDelete: any = $state(null);
	let deleteLoading = $state(false);

	// Stage visuals now sourced from shared lookups (opportunityStages)
	...
	const filteredOpportunities = $derived.by(getFilteredOpportunities);
	...
	function openDeleteModal(opportunity: any) {
			...
			<div class="min-w-full overflow-x-auto">
				<table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
					<thead class="bg-gray-50 dark:bg-gray-700">
						<tr>
							<th
								class="cursor-pointer px-6 py-3 text-left text-xs font-medium uppercase tracking-wider text-gray-500 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600"
					...
					<tbody class="divide-y divide-gray-200 bg-white dark:divide-gray-700 dark:bg-gray-800">
						{#each filteredOpportunities as opportunity (opportunity.id)}
							...
							<tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
								...
								<td class="whitespace-nowrap px-6 py-4">
									<span
										class="inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium {s
											? s.color
			...
			<div class="mt-3">
				...
				<div class="mt-6 flex justify-end space-x-3">
					<button
						...
						class="rounded-md border border-gray-300 bg-white px-4 py-2 text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600"
					>
						Cancel
					</button>
					...
					>
						...
						<button
							type="submit"
							disabled={deleteLoading}
							class="rounded-md border border-transparent bg-red-600 px-4 py-2 text-white hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
						>
