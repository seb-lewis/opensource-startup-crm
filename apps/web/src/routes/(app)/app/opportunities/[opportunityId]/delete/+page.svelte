<script lang="ts">
	...
	import { OPPORTUNITY_STAGE_OPTIONS } from '@opensource-startup-crm/constants';
			...
			<div class="rounded-lg bg-white shadow dark:bg-gray-800">
				<div class="px-6 py-8">
					...
					<div class="flex justify-end space-x-3">
						<a
							href="/app/opportunities/{data.opportunity.id}"
							class="rounded-md border border-gray-300 bg-white px-4 py-2 text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600"
						>
							Cancel
						</a>
