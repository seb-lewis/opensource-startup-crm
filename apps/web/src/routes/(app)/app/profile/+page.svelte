<script lang="ts">
	...
	import { Mail, Phone, Building, Calendar, Edit, Save, X } from '@lucide/svelte';
...
<div class="mx-auto max-w-4xl">
	...
	<div class="mb-8">
		<div class="flex items-center justify-between">
			...
			<button
				onclick={toggleEdit}
				class="inline-flex items-center gap-2 rounded-lg border border-transparent bg-blue-600 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-900"
						...
						>
							<div class="flex justify-end gap-3">
								<button
									...
									onclick={toggleEdit}
									disabled={isSubmitting}
									class="rounded-lg border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 transition-colors hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50 dark:border-gray-500 dark:bg-gray-600 dark:text-gray-300 dark:hover:bg-gray-500 dark:focus:ring-offset-gray-800"
								>
									Cancel
								</button>
								<button
									...
									class="inline-flex items-center gap-2 rounded-lg border border-transparent bg-blue-600 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50 dark:focus:ring-offset-gray-800"
								>
									{#if isSubmitting}
