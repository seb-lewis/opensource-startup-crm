<script lang="ts">
	...
	import { taskStatusOptions, taskPriorityOptions } from '$lib/data';
	...
	onMount(() => {
		if (task.dueDate) {
			const dateValue = task.dueDate as unknown as string | Date;
				...
				<div class="space-y-6 p-6">
					...
					<div class="space-y-2">
						...
						<input
							...
							id="task-subject"
							name="subject"
							class="h-12 w-full rounded-xl border border-gray-200 bg-gray-50 px-4 text-gray-900 placeholder-gray-500 transition-all duration-200 focus:border-transparent focus:bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:bg-gray-600 dark:focus:ring-blue-400"
					...
					<div class="space-y-2">
						...
						<textarea
							id="task-description"
							name="description"
							class="w-full resize-none rounded-xl border border-gray-200 bg-gray-50 px-4 py-3 text-gray-900 placeholder-gray-500 transition-all duration-200 focus:border-transparent focus:bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:bg-gray-600 dark:focus:ring-blue-400"
							rows="4"
					...
					<div class="grid grid-cols-1 gap-6 md:grid-cols-2">
						<div class="space-y-2">
							...
							<select
								id="task-status"
								name="status"
								class="h-12 w-full rounded-xl border border-gray-200 bg-gray-50 px-4 text-gray-900 transition-all duration-200 focus:border-transparent focus:bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:focus:bg-gray-600 dark:focus:ring-blue-400"
