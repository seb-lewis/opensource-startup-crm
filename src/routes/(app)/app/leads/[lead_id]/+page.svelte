        ...
        <div class="flex flex-col items-center py-6">
          <div class="relative">
            ...
            <div class="absolute -top-1 -right-1">
              <Badge color={getStatusColor(lead.status)} size="lg" class="px-3 py-1">{lead.status}</Badge>
            </div>
          </div>
                  ...
                  {#each lead.tasks as task, i}
                    <div class="border rounded-lg p-4 hover:shadow-sm transition-shadow" in:fly={{ y: 20, delay: i * 80, duration: 300 }}>
                      <div class="flex items-start justify-between">
                        <div class="flex items-center gap-2">
                          <input type="checkbox" class="w-4 h-4 text-blue-600 rounded border-gray-300" checked={task.completed} />
