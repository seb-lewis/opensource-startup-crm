    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="mb-4">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-gray-600 text-sm">Add a new task to keep track of your work</p>
                </div>
                <button
                    type="button"
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <form method="POST" use:enhance class="p-6">
                <div class="space-y-5">
                    ...
                    <div>
                        <h2 class="text-base font-semibold text-gray-900 mb-4 flex items-center">
                            <FileText size={18} class="mr-2 text-blue-600" />
                            Task Details
                        </h2>
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <input 
                                    ...
                                    name="subject" 
                                    bind:value={subject} 
                                    class="w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors placeholder-gray-400 text-sm" 
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div>
                                    ...
                                    <select 
                                        ...
                                        name="status" 
                                        bind:value={status} 
                                        class="w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors bg-white text-sm"
                                    >
                                ...
                                <div>
                                    <label for="priority" class="block text-sm font-medium text-gray-700 mb-1 flex items-center">
                                        <Flag size={14} class="mr-1 text-gray-500" />
                                        Priority
                                    </label>
                                    <select 
                                        id="priority" 
                                ...
                                <div>
                                    <label for="dueDate" class="block text-sm font-medium text-gray-700 mb-1 flex items-center">
                                        <Calendar size={14} class="mr-1 text-gray-500" />
                                        Due Date
                                    </label>
                                    <input 
                                        type="date" 
                    ...
                    <div class="border-t border-gray-200 pt-5">
                        <h2 class="text-base font-semibold text-gray-900 mb-4 flex items-center">
                            <User size={18} class="mr-2 text-blue-600" />
                            Assignment
                        </h2>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <!-- Related Account -->
                            <div>
                                <label for="accountId" class="block text-sm font-medium text-gray-700 mb-1 flex items-center">
                                    <Building size={14} class="mr-1 text-gray-500" />
                                    Related Account
                                </label>
                                <select 
                                    id="accountId" 
                    ...
                    <div class="border-t border-gray-200 pt-5">
                        <div>
                            ...
                            <textarea 
                                ...
                                class="w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors placeholder-gray-400 resize-none text-sm" 
                                rows="3" 
                ...
                <!-- Form Actions -->
                <div class="flex flex-col sm:flex-row justify-end gap-3 pt-5 mt-5 border-t border-gray-200">
                    <button 
                        type="button" 
                        class="px-5 py-2.5 rounded-lg border border-gray-300 bg-white text-gray-700 font-medium hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 transition-colors text-sm" 
                        onclick={handleCancel}
                    >
                        Cancel
                    </button>
                    <button 
                        type="submit" 
                        class="px-5 py-2.5 rounded-lg bg-blue-600 text-white font-semibold hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 shadow-sm transition-colors text-sm"
                    >
                        Create Task
                    </button>
                </div>
